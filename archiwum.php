...
<?
echo "</div>";
$news_file = fopen("edytuj/archiwum.txt", "r") or die("Blad! Nie moge otworzyc pliku news.txt");
...
// tytul
	if (strpos($linia, "[tytul]") !== false) {
		$linia = str_replace('[tytul]', '<div class="news"><div align="left"><h3 id="label_'.$nr.'">', $linia);
